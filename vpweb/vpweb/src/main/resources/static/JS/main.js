...
$(".menu-icon").on("click", "i", function () {
    $(".main-menuMB").toggleClass("hide-menu");
});
$(".main-menuMB").on("click", "li", function () {
...
(function ($) {
    ...
    function initScrollNavigate() {
        ...
        // Header sticky
        // Đã chỉnh từ if (scrollPos > (headerHeight + 150)) { thành if (scrollPos >0 {
    ...
    $(document).ready(function () {
        ...
        //         success: function (response) {
        //             $("#formMessage").removeClass("d-none").text("Registration successful! Redirecting...").css("color", "green");
        //             setTimeout(function () {
        //                 window.location.href = "/login"; // Redirect to login page after success
        //             }, 2000);
        //         },
        //         error: function (xhr) {
        //             $("#formMessage").removeClass("d-none").text("Registration failed! " + xhr.responseText).css("color", "red");
        //         }
        //     });
        // });
    })
